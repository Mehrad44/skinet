...
{
    /// <inheritdoc />
    public partial class OrderAggreagteAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ItemOrdred_ProductId = table.Column<int>(type: "int", nullable: false),
                    ItemOrdred_ProductName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ItemOrdred_PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
