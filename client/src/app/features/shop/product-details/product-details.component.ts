...
export class ProductDetailsComponent implements OnInit {
  ...
  updateCart(){
    ...
    if(this.quantity > this.quantityInCart){
      ...
      const itemstToRemove = this.quantityInCart - this.quantity;
      this.quantityInCart -= itemstToRemove;
      this.cartService.removeItemFromCart(this.product.id , itemstToRemove);
    }
  }
